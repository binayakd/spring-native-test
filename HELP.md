...
* The original package name 'com.digitlabeans.spring-native-test' is invalid and this project uses 'com.digitlabeans.springnativetest' instead.
...
```
$ docker run --rm spring-native-test:0.0.1-SNAPSHOT
```
...
```
$ build/native-image/spring-native-test
```
